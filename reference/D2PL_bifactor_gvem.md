...
- ndim:
  ...
  The first `ndim` factors are substantive, while others are nuisance
  factors

- impact:

  Whether nuisance factors are allowed to have impact
...
- ...\$gamma:
  ...
  D2PL_bifactor parameters for the slopes

- ...\$beta:

  D2PL_bifactor parameters for the intercepts
...
- ...\$l0:
  ...
  Number of nonzero D2PL_bifactor parameters in `gamma` and `beta`
