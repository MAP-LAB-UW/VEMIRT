...
Rcpp::List iwgvem_grm(
  ...
  List output = List::create(Rcpp::Named("new_A")   = new_A,
                             ...
                             // Rcpp::Named("Theta_is")   = Theta_is,
                             // Rcpp::Named("Theta_is__") = Theta_is__,
                             // Rcpp::Named("Fjr")  = Fjr,
                             // Rcpp::Named("Fjrp") = Fjrp,
                             // Rcpp::Named("tid_wis")= tid_wis,
                             // Rcpp::Named("grad_A")= grad_A,
                             // Rcpp::Named("grad_gam")= grad_gam,
                             // Rcpp::Named("grad_omg")= grad_omg,
